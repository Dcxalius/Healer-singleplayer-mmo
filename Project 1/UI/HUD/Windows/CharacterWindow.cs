...
namespace Project_1.UI.HUD.Windows
{
    internal class CharacterWindow : Window
    {
        ...
        public CharacterWindow() : base(new UITexture("WhiteBackground", Color.Turquoise))
        {
            ...
            RelativeScreenPosition reportBoxSize = new RelativeScreenPosition(1 - itemSpacing.X * 2, 1 - topPart.Y - itemSpacing.Y * 2 - expBarSize.Y);
            ...
            statPageBox.SetPageTitleProvider(GetCurrentPageTitle);
        ...
        {
            secondarySpellDetails = secondary.SpellDetails;
            BuildStatPages(primary, secondary);
            RefreshStatPage();
        }
        ...
        bool TryBuildStatHoverSnapshot(StatLineSnapshot aLine, out ItemDescriptorSnapshot aSnapshot)
        {
            ...
            switch (aLine.Name)
            {
                ...
                case "Spell Damage":
                    {
                        string report = BuildSpellBreakdownReport(aLine.Value, secondarySpellDetails.DamageBonuses, "Spell Damage", isPercent: false);
                ...
                case "Spell Crit Chance":
                    {
                        string report = BuildSpellBreakdownReport(aLine.Value, secondarySpellDetails.CritChanceBonuses, "Spell Crit Chance", isPercent: true);
                ...
                case "Spell Hit Chance":
                    {
                        string report = BuildSpellBreakdownReport(aLine.Value, secondarySpellDetails.HitChanceBonuses, "Spell Hit Chance", isPercent: true);
