...
namespace Project_1.UI.HUD.Windows.Gossip
{
    ...
    {
        public GossipOption(UIElement aParent, string aDescriptor) : base(aParent, RelativeScreenPosition.Zero, RelativeScreenPosition.Zero, Color.DarkGreen, aDescriptor)
        {
