...
namespace Project_1.UI.HUD.Guild
{
    internal class OpenInspectWindow : GFXButton
    {
        ...
        public OpenInspectWindow(UI.UIElements.UIElement aParent, EntityUiSnapshot aSnapshot, RelativeScreenPosition aPos, RelativeScreenPosition aSize) : base(aParent, new List<Action>() { new Action(() => OpenWindow(aSnapshot)) }, new GfxPath(GfxType.Item, "TestDagger"), aPos, aSize, Color.White)
        {
