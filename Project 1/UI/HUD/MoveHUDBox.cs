...
namespace Project_1.UI.HUD
{
    internal class MoveHUDBox : ABDialogueBox
    {
        ...
        static RelativeScreenPosition Spacing => RelativeScreenPosition.GetSquareFromX(0.005f, Size.ToAbsoluteScreenPos());
            ...
            new UITexture("WhiteBackground", Color.Black), Pos, Size, AButtonPos, BButtonPos, ButtonSize, Color.Gray, "Confirm", "Reset", Color.White)
        {
            ...
            sizeChangeCheckBox = new DescriptCheckBox("Size change", Color.White, false, HUDManager.ChangeSizes, HUDManager.DisableSizeChanges, Spacing + new RelativeScreenPosition(0.05f).OnlyY, new RelativeScreenPosition(1f, 0.15f));
