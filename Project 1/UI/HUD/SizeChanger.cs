...
namespace Project_1.UI.HUD
{
    internal class SizeChanger : Box
    {
        ...
        public SizeChanger() : base(new UITexture("GrayBackground", Color.Gray), RelativeScreenPosition.Zero, new RelativeScreenPosition(0.2f, 0.2f))
        {
            ...
            name = new Label("", labelSpacing, RelativeScreenPosition.One - labelSpacing * 2, Label.TextAllignment.TopCentre, Color.White, aParent: this);
            AddChild(name);
            ...
            directionButtons[0] = new GFXButton(new List<Action> { NudgeValues(Cardinals.Up) }, new GfxPath(GfxType.UI, "UpArrow"), pos, buttonSize, Color.White, aParent: this);
            directionButtons[1] = new GFXButton(new List<Action> { NudgeValues(Cardinals.Down) }, new GfxPath(GfxType.UI, "DownArrow"), pos + buttonSize.OnlyY, buttonSize, Color.White, aParent: this);
            directionButtons[2] = new GFXButton(new List<Action> { NudgeValues(Cardinals.Left) }, new GfxPath(GfxType.UI, "LeftArrow"), pos - buttonSize.OnlyX + buttonSize.OnlyY / 2, buttonSize, Color.White, aParent: this);
            directionButtons[3] = new GFXButton(new List<Action> { NudgeValues(Cardinals.Right) }, new GfxPath(GfxType.UI, "RightArrow"), pos + buttonSize.OnlyX + buttonSize.OnlyY / 2, buttonSize, Color.White, aParent: this);
            ...
            directionBoxX = new InputBox("X", Size, new InputBox.ValidInputs[] { InputBox.ValidInputs.Digits }, Color.Black, "", Color.White, false, Color.Black, Color.Black, RelativeScreenPosition.One - inputSize - inputSize.OnlyY - spacing - spacing.OnlyY, inputSize, this);
            directionBoxY = new InputBox("Y", Size, new InputBox.ValidInputs[] { InputBox.ValidInputs.Digits }, Color.Black, "", Color.White, false, Color.Black, Color.Black, RelativeScreenPosition.One - inputSize - spacing, inputSize, this);
