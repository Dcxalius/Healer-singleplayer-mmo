...
namespace Project_1.UI.OptionMenu
{
    internal class DebugOptionsPanel : Box
    {
        ...
        public DebugOptionsPanel(RelativeScreenPosition aPos, RelativeScreenPosition aSize) : base(null, new UITexture("GrayBackground", Color.WhiteSmoke), aPos, aSize)
        {
            capturesClick = false;
    ...
    {
        public DebugToggleRow(UIElement aParent, string aLabel, bool aStartState, Action aOnTicked, Action aOnUnticked, RelativeScreenPosition aPos, RelativeScreenPosition aSize)
