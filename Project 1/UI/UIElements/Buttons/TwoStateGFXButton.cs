...
namespace Project_1.UI.UIElements.Buttons
{
    internal class TwoStateGFXButton : Button
    {
        ...
        public TwoStateGFXButton(UIElement aParent, List<Action> aActions, GfxPath aPath, List<Action> aSecondActions, GfxPath aSecondPath, RelativeScreenPosition aPos, RelativeScreenPosition aSize, Color aColor, string aText = null, Color? aTextColor = null) : base(aParent, aActions, aPos, aSize, aColor, aText, aTextColor)
        {
            state = State.First;
