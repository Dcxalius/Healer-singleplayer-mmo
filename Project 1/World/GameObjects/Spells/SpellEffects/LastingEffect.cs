...
namespace Project_1.World.GameObjects.Spells.SpellEffects
{
    internal abstract class LastingEffect : SpellEffect
    {
        ...
        public LastingEffect(double aDuration, string aName, bool aIsBinary, HashSet<Project_1.GameObjects.Unit.Stats.SpellSchool> aSpellSchools) : base(aName, aIsBinary, aSpellSchools)
        {
